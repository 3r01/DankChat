...
object EmoteScaling {
     ...
     */
    fun getBaseHeight(fontSizeSp: Float): Dp {
        return (fontSizeSp * BASE_HEIGHT_CONSTANT).dp
    }
    ...
    fun getScaleFactor(baseHeightPx: Int): Double {
        return baseHeightPx * SCALE_FACTOR_CONSTANT
    }
     ...
     */
    fun getBadgeSize(fontSizeSp: Float): Dp {
        return getBaseHeight(fontSizeSp)
    }
}
