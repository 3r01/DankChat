...
data class ChatSettings(
    ...
    val showSevenTVPersonalEmotes: Boolean = false,
    val showSevenTVBadges: Boolean = true,
    val showSevenTVPaints: Boolean = false,
    val animateSevenTVPaints: Boolean = true,
    val sevenTVLiveEmoteUpdates: Boolean = true,
    val sendSevenTVActivity: Boolean = true,
