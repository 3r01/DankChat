...
fun MessageIgnoreEntity.toItem() =
    MessageIgnoreItem(
        id = id,
...
fun MessageIgnoreItem.toEntity() =
    MessageIgnoreEntity(
        id = id,
...
fun MessageIgnoreItem.Type.toEntityType(): MessageIgnoreEntityType =
    when (this) {
...
fun MessageIgnoreEntityType.toItemType(): MessageIgnoreItem.Type =
    when (this) {
...
fun IgnoresRepository.TwitchBlock.toItem() =
    TwitchBlockItem(
