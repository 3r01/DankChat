...
sealed interface SevenTVEventMessage {
    data class EmoteSetUpdated(val emoteSetId: String, val actorName: DisplayName, val added: List<SevenTVEmoteDto>, val removed: List<RemovedEmote>, val updated: List<UpdatedEmote>) :
        SevenTVEventMessage {
