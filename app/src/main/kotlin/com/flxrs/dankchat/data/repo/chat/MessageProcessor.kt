...
class MessageProcessor(
    ...
    suspend fun processIrcMessage(
        ...
        return Message.parse(ircMessage, channelRepository::tryGetUserNameById)
    ...
    suspend fun reparseEmotesAndBadges(message: Message): Message {
        return message.parseEmotesAndBadges().updateMessageInThread()
    }
